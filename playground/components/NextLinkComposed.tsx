// This file is a copy of the file from the MUI documentation:
// https://github.com/mui/material-ui/blob/v5.15.15/examples/material-ui-nextjs-pages-router-ts/src/Link.tsx
